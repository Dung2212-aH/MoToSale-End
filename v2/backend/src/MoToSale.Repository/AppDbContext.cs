...
public class AppDbContext : DbContext
{
    ...
    public DbSet<InstallmentTerm> InstallmentTerms => Set<InstallmentTerm>();
    ...
    protected override void OnModelCreating(ModelBuilder b)
    {
        ...
        b.Entity<PasswordResetToken>(e =>
        {
            ...
            e.Property(x => x.TokenHash).HasMaxLength(128).IsUnicode(false).IsRequired();
            e.Property(x => x.UserAgent).HasMaxLength(255);
            e.Property(x => x.IpAddress).HasMaxLength(64);
            e.Property(x => x.ExpiresAt).HasColumnType("datetime2(0)");
            e.Property(x => x.UsedAt).HasColumnType("datetime2(0)");
    ...
    private static void ConfigureOrdering(ModelBuilder b)
    {
        ...
        b.Entity<OrderStatusHistory>(e =>
        {
            ...
            e.Property(x => x.Note).HasMaxLength(500);
            e.HasIndex(x => x.OrderId);
            e.HasOne<Order>().WithMany(o => o.StatusHistories).HasForeignKey(x => x.OrderId).OnDelete(DeleteBehavior.Restrict);
        ...
        b.Entity<OrderVoucher>(e =>
        {
            ...
            e.HasOne<Order>().WithMany(o => o.Vouchers).HasForeignKey(x => x.OrderId).OnDelete(DeleteBehavior.Restrict);
        ...
        b.Entity<UserVoucher>(e =>
        {
            ...
            e.Property(x => x.VoucherStatus).HasMaxLength(20).IsUnicode(false).IsRequired();
            e.Property(x => x.DiscountAmount).HasPrecision(18, 2);
            e.Property(x => x.SavedAt).HasColumnType("datetime2(0)");
            e.Property(x => x.UsedAt).HasColumnType("datetime2(0)");
