...
public interface IContentService
{
    ...
    Task<PagingResponse<PublicPostListItem>> GetPublishedPostsAsync(PagingRequest request);
    Task<PublicPostDto?> GetPublishedPostBySlugAsync(string slug);
    ...
    Task<int> CreateContactRequestAsync(ContactRequestForm request);
