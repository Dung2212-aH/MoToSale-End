...
export default {
  getLookups: () => api.get(`${root}/lookups`), getOperationsSummary: () => api.get(`${root}/summary`),
  ...
  getRepairs: () => api.get(`${root}/repairs`), createRepair: (data) => api.post(`${root}/repairs`, data), updateRepairStatus: (id, data) => api.put(`${root}/repairs/${id}/status`, data),
